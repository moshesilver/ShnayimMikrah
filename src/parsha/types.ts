...
export interface TextFetchSettings {
  english: boolean;
  targum: boolean;
  rashi: boolean;
...
export type EnglishTextVersionOptions =
  | 'The_Koren_Jerusalem_Bible'
  | 'Metsudah Chumash, Metsudah Publications, 2009';

export type TargumVersionOptions = 'Onkelos, Metsudah Publications, 2009';

export type RashiVersionOptions = 'Rashi Chumash, Metsudah Publications, 2009';

export type RashiEnglishVersionOptions =
...
export type TextResponse = InternalTextResponse<
  string | string[] | Array<string[]>
>;
export type ChumashTextResponse = InternalTextResponse<Array<string[]>>;

// possibly rename to ParshaRequestContext
...
export type ParshaName = (typeof ParshaName)[keyof typeof ParshaName];
...
export interface DownloadArgs {
  ...
  // textFetchSettings: TextFetchSettings;
}
